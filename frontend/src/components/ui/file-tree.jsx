  ...
  return (
    <AccordionPrimitive.Item {...props} value={value} className="relative h-full overflow-hidden">
      ...
      <AccordionPrimitive.Content
        className="data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down relative h-full overflow-hidden text-sm">
  ...
  return (
    <button
      ...
      className={cn(
        ...
        {
          "border-1 border-primary bg-primary text-primary-foreground p-1": isSelected && isSelectable,
        },
